...
//  WeatherGift
//
//  Created by Walker Vonder Haar on 6/14/19.
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            print("cannot show location user did not authorize")
        case.restricted:
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let currentLogitude = currentLocation.coordinate.longitude
        let currentCoordinates = "\(currentLatitude),\(currentLogitude)"
        geoCoder.reverseGeocodeLocation(currentLocation, completionHandler: {placemarks, error in
            if placemarks != nil{
                ...
                place = "Unknownn weather location"
            }
